...
Plugin URI: https://www.oik-plugins.com/oik-plugins/oik-widget-cache
Description: Caches widget output for selected widgets
Version: 0.0.2
Author: bobbingwide
Author URI: https://www.bobbingwide.com/about_bobbingwide
Text Domain: oik-widget-cache
Domain Path: /languages/
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html

    Copyright 2016-2020 Bobbing Wide (email : herb@bobbingwide.com )
